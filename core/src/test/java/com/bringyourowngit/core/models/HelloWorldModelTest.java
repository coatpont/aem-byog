 ...
 */
package com.bringyourowngit.core.models;
...
import com.bringyourowngit.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "bringyourowngit/components/helloworld");
